...
extern struct obs_source_info create_omt_source_info();
struct obs_source_info omt_source_info;
...
bool obs_module_load(void)
{
	...
	omt_source_info = create_omt_source_info();
	obs_register_source(&omt_source_info);
